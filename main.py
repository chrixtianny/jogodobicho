...
def telaAposta():
    ...
    while True:
        ...
        botao_voltar = botao(image=pygame.image.load("assets/botaovoltar.png"), pos=(345, 670), 
...
def menu():
    ...
    while True:
        ...
        botao_jogar = botao(image=pygame.image.load("assets/botao1.png"), pos=(239, 518), 
        ...
        s.ImagemBotao = pygame.transform.scale(s.ImagemBotao, (210, 64))
